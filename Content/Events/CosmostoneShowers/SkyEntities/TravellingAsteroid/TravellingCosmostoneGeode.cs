...
namespace TwilightEgress.Content.Skies.SkyEntities.TravellingAsteroid
{
    public class TravellingCosmostoneGeode : SkyEntity
    {
        ...
        {
            Texture2D asteroid = ModContent.Request<Texture2D>("TwilightEgress/Assets/Textures/NPCs/CosmostoneShowers/Asteroids/CosmostoneGeode").Value;
            Texture2D glow = ModContent.Request<Texture2D>("TwilightEgress/Assets/Textures/NPCs/CosmostoneShowers/Asteroids/CosmostoneGeode_Glow").Value;

...
{
    public class CosmostoneMeteoroidSmall : Meteoroid, ILocalizedModType, IPixelatedPrimitiveRenderer
    {
        ...
        {
            Texture2D glowmask = AssetRegistry.Textures.Meteoroids.CosmostoneMeteoroidSmall_Glowmask.Value; ;
